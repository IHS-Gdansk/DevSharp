...
app.controller("translateCtrl",['$scope', function($scope){
    dict = {
        ...
        "intro.3": { 
            "en": "After the talks, there will be a networking party for all attendees. To ensure proper vibe, we chose Stary Maneż in Gdansk, known for great concerts, delicious cuisine and excellent beer brewed locally.", 
